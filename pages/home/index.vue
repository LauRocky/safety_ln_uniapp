	...
	<view class="home">
		...
		<view class="main">
			...
			<view class="main-prompt main-top">
				<u-notice-bar bgColor="#ffffff" duration="3000" color="#333333" direction="column" :text="swiperList">
				</u-notice-bar>
			...
			<view class="mask">
				...
				<u-checkbox-group placement="row" @change="checkboxChange(!showPopup)">
					<view class="maskRadio">
						<u-checkbox :checked="showPopup" label="勾选后下次不再弹窗提示" name="勾选后下次不再弹窗提示"></u-checkbox>
					</view>
				</u-checkbox-group>
			</view>
		</u-popup>
