<template>
	<view class="home">
		...
		<view class="main">
			...
			<view class="bulletinBoard main-top">
				<u-notice-bar :text="text1" :bgColor="bgColor" :icon="icon" :color="textColor"></u-notice-bar>
			</view>
			<view class="bulletinBoard main-top">
				<view class="bulletin">
					<view class="bulletinImage" style="flex: 1;">
						<image src="../../static/home/noticeBar.png" style="height: 40upx; width: 40upx;"></image>
					</view>
					<view style="flex: 4;">说明：登录电脑端请访问</view>
					<view style="flex: 4;color: #00b490;">https://esq.cgdg.com/</view>
				</view>
			</view>
...
<script>
	...
	export default {
		...
		data() {
			return {
				text1: '说明：登录电脑端请访问https://esq.cgdg.com/',
				textColor: "#00b490",
				bgColor: "#FFFFFF",
				icon: "../../static/home/noticeBar.png",
				project: {
					projectName: '',
