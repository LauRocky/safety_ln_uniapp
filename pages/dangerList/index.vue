			...
			<view class="list-1" v-for="(val, i) in numsList" :key="i" @click="handLsit(val.id)">
				<view class="list-top">
					...
					<view class="list-right">
						...
						<view class="list-title" v-if="val.projectInfoEntity">{{ val.projectInfoEntity.projectName }}
						</view>
						<view class="list-ce">
							请{{ val.problemSolverDisplay }}{{ val.problemRequire }}{{ val.notifyPersonDisplay }}</view>
					</view>
				</view>
				<view class="list-foo">
